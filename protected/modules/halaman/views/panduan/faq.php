<div class="content-base tinggi-350">
    <h3 class="content-tittle">Pertanyaan Umum</h3>
    <div class="content-submenu">
        ...
        <ul class="list-submenu">
            <li><?php echo CHtml::link('Panduan', array('/halaman/panduan'), array('class' => '')); ?></li>
            <li><?php echo CHtml::link('Pertanyaan Umum', array('/halaman/panduan/faq'), array('class' => 'active')); ?></li>
        </ul>
    </div>
